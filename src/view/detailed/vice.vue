<template>
    <div class="app-problem">
        <div class="problem-left">
            <left-list @child-click="childClick" flag='vice' :ind=this.$route.params.ind></left-list>
        </div>
        <div class="problem-right ove-right-pad">
            ...
            <div class="tab-out">
                <el-table :data="tableDataAll" :span-method="objectSpanMethod" style="margin-bottom:20px" border stripe
                    size="small">
    ...
    export default {
        ...
        methods: {
            ...
            exportData() {
                ...
                current=${this.current}&errorType=${this.errorType}&flag=${this.flag}&professional=7&size=${this.size}&id=${this.changeId}&status=${this.status}&professionalLevel=vice`
                location.href = url;
            },
