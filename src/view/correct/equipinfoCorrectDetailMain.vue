<template>
    <div class="app-correct">
        <div class="ove-title">设备信息智能纠错明细--主网设备</div>
...
<script>
    import {getClassifyMain,getModelByClassifyMain,getDetailsMain,checkDevModelMain,checkDevModelByOne} from  "../../request/api.js"
