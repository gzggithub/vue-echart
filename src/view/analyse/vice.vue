    ...
    <div class="app-analyse">
        ...
        <div class="analyse-right ove-right-pad">
            ...
            <div class="one-chart">
                ...
                <!-- <div v-if="showOnePie" id="onePie" class="include-chart border-right"></div>
                <div v-if="showOneBar" id="oneBar" class="include-chart"></div>
                <div v-if="showTwoLeft" id="twoBarLeft" class="include-chart"></div>
            ...
            <div class="three-chart">
                <el-row>
                    <el-col v-if="showTwoRight" :span="12" class="border-right">
...
<script>
    ...
    import {
        queryProfessionalQuestionQualityAnalysisInfoVice,
        queryDeviceParetoChartVice,
        queryGradeParetoChartVice
    } from '../../request/api';
